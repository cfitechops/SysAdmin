...
samba@samba:~$ sudo apt update
samba@samba:~$ sudo apt install samba -y
samba@samba:~$ samba --version
samba@samba:~$ sudo adduser john

samba@samba:~$ cd /home/
samba@samba:/home$ ll
samba@samba:/home$ sudo mkdir group
samba@samba:/home$ ll
samba@samba:/home$ sudo groupadd smbgroup
samba@samba:/home$ sudo chgrp smbgroup /home/group/
samba@samba:/home$ sudo chmod 770 /home/group/
samba@samba:/home$ cd /etc/samba/
samba@samba:/etc/samba$ sudo cp smb.conf smb.conf.bak

samba@samba:/etc/samba$ sudo nano smb.conf
...
force create mode = 0770
# set all new folders to members only
force directory mode = 0770
# inherit permissions from parent folder
inherit permissions = yes
```

samba@samba:/etc/samba$ sudo chmod 755 /home/john/
samba@samba:/etc/samba$ sudo smbpasswd -a john
samba@samba:/etc/samba$ sudo usermod -aG smbgroup john
samba@samba:/etc/samba$ sudo systemctl restart smbd
samba@samba:/etc/samba$ sudo systemctl status smbd
samba@samba:/etc/samba$ sudo ufw allow samba

samba@samba:/etc/samba$ sudo apt install smbclient
samba@samba:/etc/samba$ smbclient //192.168.129.152/Group -U john
...
#### À tester ensuite (facultatif mais recommandé) :

- Connexion depuis un poste Windows via `\\192.168.129.152\Group`
